...
## Failures
- `pipeline_preflight_failed`: {'type': 'pipeline_preflight_failed', 'message': 'No configured STT provider API secret is available in the local environment.', 'missingSecrets': ['SARVAM_API_KEY']}
