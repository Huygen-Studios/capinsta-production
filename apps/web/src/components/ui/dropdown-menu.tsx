...
const dropdownMenuItemVariants = cva(
	"relative flex cursor-pointer select-none items-center gap-2 rounded-sm border-2 border-transparent px-2.5 py-1.5 text-sm text-foreground/90 outline-hidden data-[highlighted]:border-primary data-[highlighted]:bg-popover-hover data-disabled:pointer-events-none data-disabled:opacity-50 [&>svg]:size-4 [&>svg]:shrink-0",
	{
		variants: {
			variant: {
				default: "",
...
>(({ className, ...props }, ref) => (
	<DropdownMenuPrimitive.SubContent
		ref={ref}
		className={cn(
			"group/menu z-50 min-w-32 overflow-hidden rounded-sm border-2 bg-popover p-1 text-popover-foreground shadow-[4px_4px_0_var(--cap-shadow-color)]",
			className,
		)}
		{...props}
	/>
