...
const sheetVariants = cva(
	"fixed z-250 gap-4 bg-background p-6 shadow-[4px_4px_0_#000] transition ease data-[state=closed]:duration-250 data-[state=open]:duration-250 data-[state=open]:animate-in data-[state=closed]:animate-out",
	{
		variants: {
			side: {
