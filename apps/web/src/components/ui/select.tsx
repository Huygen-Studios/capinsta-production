...
const selectItemVariants = cva(
	"relative flex cursor-pointer select-none items-center gap-1.5 rounded-sm px-2 py-1 text-sm text-foreground/90 outline-hidden data-[highlighted]:bg-popover-hover data-disabled:pointer-events-none data-disabled:opacity-50 [&>svg]:size-4 [&>svg]:shrink-0",
	{
		variants: {
			variant: {
				default: "",
...
const selectTriggerVariants = cva(
	"border-border ring-offset-background placeholder:text-muted-foreground flex h-8 w-auto cursor-pointer items-center justify-between gap-1 rounded-sm border-2 px-2.5 text-sm font-semibold whitespace-nowrap transition-colors focus:border-primary focus:ring-2 focus:ring-primary/20 focus:outline-hidden disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
	{
		variants: {
			variant: {
				default:
