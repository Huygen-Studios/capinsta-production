	...
	return (
		<TabsPrimitive.Trigger
			...
			className={cn(
				...
				variant === "default" &&
					"border border-transparent data-[state=active]:bg-secondary data-[state=active]:border-primary data-[state=active]:text-secondary-foreground data-[state=active]:shadow-[2px_2px_0_#000] rounded-sm px-2.5 h-6.5",
				variant === "underline" &&
