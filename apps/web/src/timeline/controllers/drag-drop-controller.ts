...
function shouldInsertVideoWithLinkedAudio({
	mediaAsset,
}: {
	mediaAsset: MediaAsset;
}): boolean {
	return mediaAsset.type === "video" && mediaAsset.hasAudio !== false;
}
