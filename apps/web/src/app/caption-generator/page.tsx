...
const page = getKeywordPage("caption-generator");
export const metadata: Metadata = { title: page.title, description: page.description, alternates: { canonical: "/caption-generator" } };
