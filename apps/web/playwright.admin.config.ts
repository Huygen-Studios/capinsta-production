...
process.env.CAPINSTA_UI_TEST_AUTH = process.env.CAPINSTA_UI_TEST_AUTH ?? "true";
...
const localEnv = {
	...
	DATABASE_URL:
		...
		"postgresql://capinsta:capinsta@127.0.0.1:54322/capinsta",
	...
	ENABLE_CLIPPER_UI: process.env.ENABLE_CLIPPER_UI ?? "true",
	NEXT_PUBLIC_CAPINSTA_E2E: process.env.NEXT_PUBLIC_CAPINSTA_E2E ?? "true",
