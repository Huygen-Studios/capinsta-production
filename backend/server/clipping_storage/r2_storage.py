...
class R2MediaStorage(MediaStorage):
    def __init__(self, config: MediaStorageConfig, *, client: Any | None = None) -> None:
        ...
        self.client = boto3.client(
            ...
            verify=config.r2_verify_tls,
            config=Config(
                connect_timeout=config.r2_connect_timeout_seconds,
                read_timeout=config.r2_read_timeout_seconds,
                retries={"max_attempts": config.r2_max_retry_attempts, "mode": "standard"},
