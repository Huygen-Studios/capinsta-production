...
TIMING_PRESETS: tuple[TimingPreset, ...] = (
    _preset(
        ...
        "Fast Performance",
        "Performance",
        "P95 latency optimization using large chunks and selective fallback.",
        {
            "TIMING_SOURCE_POLICY": "native_then_forced",
            "VAD_TARGET_SECONDS": 24.0,
            "VAD_MAX_SECONDS": 28.0,
            "CHUNK_PADDING_SECONDS": 0.18,
            "ENABLE_STABLE_TS": False,
            "SARVAM_CONCURRENCY": 4,
        },
    ...
    _preset(
        ...
        "Performance",
        "Balanced accuracy and speed; targeted WhisperX/Stable TS fallback on invalid chunks.",
        {
            "TIMING_SOURCE_POLICY": "native_then_forced",
            "VAD_TARGET_SECONDS": 24.0,
            "VAD_MAX_SECONDS": 28.0,
    ...
    _preset(
        ...
        "High Quality",
        "Performance",
        "P95 latency optimization using large chunks and dual targeted fallbacks.",
        {
            "TIMING_SOURCE_POLICY": "native_then_forced",
            "VAD_TARGET_SECONDS": 24.0,
            "VAD_MAX_SECONDS": 28.0,
    ...
    _preset(
        ...
        "High Accuracy",
        "Performance",
        "Maximum accuracy using standard 8-12s chunk sizes and full alignment checks.",
        {
            "TIMING_SOURCE_POLICY": "native_then_forced",
            "VAD_TARGET_SECONDS": 8.0,
            "VAD_MAX_SECONDS": 12.0,
            "CHUNK_PADDING_SECONDS": 0.18,
            "ENABLE_STABLE_TS": True,
            "SARVAM_CONCURRENCY": 2,
        },
        status="production_ready",
