...
export const CAPTION_PRESET_REGISTRY: Record<CaptionStylePresetId, CaptionPresetDefinition> = {
  ...
  dynamic_punch: {
    id: "dynamic_punch",
    name: "Dynamic Punch",
    description: "1-word viral kinetic typography with heavy outline, hard shadow, and explosive spring pop.",
    previewText: "PUNCH POP",
    renderer: "dynamic_punch",
    defaultStyleConfig: normalizeCaptionStyleConfig({
    ...
    supportedControls: ["font", "stroke", "shadow", "pop strength", "random tilt", "smart colors", "position"],
  },
};
